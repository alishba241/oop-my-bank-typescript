...
class BankAccount {
    ...
    withdraw(amount) {
        if (this.balance >= amount) {
            this.balance -= amount;
            console.log(chalk.yellowBright(`Withdrawl of $${amount} successful. Remaining balance: $${this.balance}`));
        }
        else {
    ...
    deposite(amount) {
        ...
        this.balance += amount;
        console.log(chalk.yellowBright(`Deposite of $${amount} successful. Remaining balance: $${this.balance}`));
    }
    //check balance
    CheckBalance() {
...
async function service() {
    do {
        ...
        const costumer = customers.find((customer) => customer.account.accountNumber === accountNumberInput.accountNumber);
        if (costumer) {
